...
psxy     TEMP/closedTemp.txt          -R -JL -St$sizepsA -G$temp   -W$thps/$blck -K -O >> $psfilep02 # closed temporary have the same color as other temporary, as in this map, many temporary are closed from the old experiments
...
psxy     AUXI/AlpArrayTemp.txt        -R -JL -St$sizepsA -G$temp    -W$thps/$blck -K -O >> $psfilep02
psxy     AUXI/stations-PACASE.txt     -R -JL -St$sizepsA -G$temp    -W$thps/$blck -K -O >> $psfilep02
...
psxy -R -JM -St$triasize -G$perm  -W$thickL/$blck -K -O << end >> $psfilep02
-5.8 0.3
end
psxy -R -JM -St$triasize -G$futu  -W$thickL/$blck -K -O << end >> $psfilep02
-2.8 0.3
end
psxy -R -JM -St$triasize -G$temp  -W$thickL/$blck -K -O << end >> $psfilep02
+0.2 0.3
end
psxy -R -JM -St$triasize -G$outsA -W$thickL/$blck -K -O << end >> $psfilep02
+3.2 0.3
end
psxy -R -JM -St$triasize -G$blck  -W$thickL/$blck -K -O << end >> $psfilep02
-5.8 0.0
end
psxy -R -JM -St$triasize -G$igczclr -W$thickL/$blck -K -O << end >> $psfilep02
-2.8 0.0
end
psxy -R -JM -St$triasize -G$ouluclr -W$thickL/$blck -K -O << end >> $psfilep02
+0.2 0.0
end
psxy -R -JM -St$triasize -G$wienclr -W$thickL/$blck -K -O << end >> $psfilep02
+3.2 0.0
end
psxy -R -JM -St$triasize -G$municlr -W$thickL/$blck -K -O << end >> $psfilep02
-5.8 -0.3
end
psxy -R -JM -St$triasize -G$twenclr -W$thickL/$blck -K -O << end >> $psfilep02
-2.8 -0.3
end
psxy -R -JM -St$triasize -G$aarhclr -W$thickL/$blck -K -O << end >> $psfilep02
+0.2 -0.3
end
psxy -R -JM -St$triasize -G$polaclr -W$thickL/$blck -K -O << end >> $psfilep02
+3.0 -0.3
end
psxy -R -JM -St$triasize -G$resfclr -W$thickL/$blck -K -O << end >> $psfilep02
+3.4 -0.3
end
# text of the legend
...
-2.55  0.38 10 0 0 TL planned permanent stations
+0.45  0.53 10 0 0 TL temporary stations: AlpArray
+0.45  0.33 10 0 0 TL PACASE and AdriaArray
+3.45  0.38 10 0 0 TL additional BB stations
-5.55  0.08 10 0 0 TL closed stations
-2.55  0.08 10 0 0 TL EASI
+0.45  0.08 10 0 0 TL CASE
+3.45  0.08 10 0 0 TL IvreaArray
-5.55 -0.22 10 0 0 TL Swath-D
-2.55 -0.22 10 0 0 TL LiSard
+0.45 -0.22 10 0 0 TL StressTransfer
...
psxy -R -JM -St$triasize -G$topo -W$thickL/$blck -K -O << end >> $psfilep03
+2.4 0.0
end
...
psxy -R -JM -St$triasize -G$grey    -W$thickL/$blck -K -O << end >> $psfilep04 # permanent
-5.8 +0.84
end
psxy -R -JM -St$triasize -G$igczclr -W$thickL/$blck -K -O << end >> $psfilep04 # IG CAS CZ
-5.8 +0.56
end
psxy -R -JM -St$triasize -G$helsclr -W$thickL/$blck -K -O << end >> $psfilep04 # Helsinki
-5.8 +0.28
end
psxy -R -JM -St$triasize -G$helsclr -W$thickL/$blck -K -O << end >> $psfilep04 # Helsinki+IRSM
-5.8  0.0
end
psxy -R -JM -Sc0.16 -G$irsmclr                      -K -O << end >> $psfilep04 # Helsinki+IRSM
-5.8  0.0
end
psxy -R -JM -St$triasize -G$aarhclr -W$thickL/$blck -K -O << end >> $psfilep04 # Denmark
-5.8 -0.28
end
psxy -R -JM -St$triasize -G$polaclr -W$thickL/$blck -K -O << end >> $psfilep04 # Poland
-5.8 -0.56
end
psxy -R -JM -St$triasize -G$ouluclr -W$thickL/$blck -K -O << end >> $psfilep04 # Oulu
-5.8 -0.84
end
psxy -R -JM -St$triasize -G$ouluclr -W$thickL/$blck -K -O << end >> $psfilep04 # Oulu+UniWien
-5.8 -1.12
end
psxy -R -JM -Sc0.16 -G$wienclr                      -K -O << end >> $psfilep04 # Oulu+UniWien
-5.8 -1.12
end
psxy -R -JM -St$triasize -G$brzgclr -W$thickL/$blck -K -O << end >> $psfilep04 # Norway + Zagreb
-2.8 +0.84
end
psxy -R -JM -St$triasize -G$kielclr -W$thickL/$blck -K -O << end >> $psfilep04 # Kiel
-2.8 +0.56
end
psxy -R -JM -St$triasize -G$epssclr -W$thickL/$blck -K -O << end >> $psfilep04 # Hungary
-2.8 +0.28
end
psxy -R -JM -St$triasize -G$twenclr -W$thickL/$blck -K -O << end >> $psfilep04 # Netherlands
-2.8 -0.00
end
psxy -R -JM -St$triasize -G$bochclr -W$thickL/$blck -K -O << end >> $psfilep04 # Bochum
-2.8 -0.28
end
psxy -R -JM -St$triasize -G$bochclr -W$thickL/$blck -K -O << end >> $psfilep04 # Bochum + Frankfurt
-2.8 -0.56
end
psxy -R -JM -Sc0.16 -G$frnkclr                      -K -O << end >> $psfilep04 # Bochum + Frankfurt
-2.8 -0.56
end
psxy -R -JM -St$triasize -G$municlr -W$thickL/$blck -K -O << end >> $psfilep04 # Munich
-2.8 -0.84
end
...
psxy -R -JM -St$triasize -G$kitpclr -W$thickL/$blck -K -O << end >> $psfilep04 # KIT
+3.2  0.56
end
psxy -R -JM -St$triasize -G$gippclr -W$thickL/$blck -K -O << end >> $psfilep04 # GIPP + IRSM
+3.2  0.28
end
psxy -R -JM -Sc0.16 -G$irsmclr                      -K -O << end >> $psfilep04 # GIPP + IRSM
+3.2  0.28
end
psxy -R -JM -St$triasize -G$gippclr -W$thickL/$blck -K -O << end >> $psfilep04 # GIPP + CarP
+3.2  0.0
end
psxy -R -JM -Sc0.16 -G$jenaclr                      -K -O << end >> $psfilep04 # GIPP + CarP
+3.2  0.0
end
psxy -R -JM -St$triasize -G$gippclr -W$thickL/$blck -K -O << end >> $psfilep04 # GIPP
+3.2  -0.28
end
psxy -R -JM -St$triasize -G$jenaclr -W$thickL/$blck -K -O << end >> $psfilep04 # Jena
+3.2  -0.56
end
psxy -R -JM -St$triasize -G$gigeclr -W$thickL/$blck -K -O << end >> $psfilep04 # Geoazur + GIPP
+3.2  -0.84
end
...
# legend to map p05 - COVERAGE - permanent only - for paper
...
psxy -R -JM -St0.6 -G$bb60 -W$thickL/$blck -K -O << end >> $psfilep07
-5.8  0.30
end
psxy -R -JM -St0.6 -G$bb40 -W$thickL/$blck -K -O << end >> $psfilep07
-5.8  0.00
end
psxy -R -JM -St0.6 -G$bb30 -W$thickL/$blck -K -O << end >> $psfilep07
-5.8 -0.3
end
psxy -R -JM -St0.6 -G$futu -W$thickL/$blck -K -O << end >> $psfilep07
-5.8 -0.6
end
psxy -R -JM -St0.6 -G$upgr -W$thickL/$blck -K -O << end >> $psfilep07
-2.8  0.3
end
...
# temp stations - contours
psxy -R -JM -St0.6 -W$thickL/$blck -K -O << end >> $psfilep07
+0.2  0.3
end
psxy -R -JM -St0.6 -W$thickL/$blck -K -O << end >> $psfilep07
+0.2  0.00
...
+3.45 -0.50 10 0 0 TL temporary other
end
...
psxy -R -JM -St0.6 -G$upgr -W$thickL/$blck -K -O << end >> $psfilep08
-5.6 0.0
end
psxy -R -JM -St0.6 -G$pcse -W$thickL/$blck -K -O << end >> $psfilep08
+0.8 0.0
end
# text of the legend
...
psxy -R -JM -St0.6 -G$bb240 -W$thickL/$blck -K -O << end >> $psfilep09
-5.8  0.0
end
psxy -R -JM -St0.6 -G$bb120 -W$thickL/$blck -K -O << end >> $psfilep09
-3.8  0.0
end
psxy -R -JM -St0.6 -G$bb60 -W$thickL/$blck -K -O << end >> $psfilep09
-1.8  0.0
end
psxy -R -JM -St0.6 -G$bb40 -W$thickL/$blck -K -O << end >> $psfilep09
+0.2  0.0
end
psxy -R -JM -St0.6 -G$bb30 -W$thickL/$blck -K -O << end >> $psfilep09
+2.2  0.0
end
psxy -R -JM -St0.6 -G$grey -W$thickL/$blck -K -O << end >> $psfilep09
+4.2  0.0
end
# text of the legend
...
psxy -R -JM -St0.6 -G$clr1Y -W$thickL/$blck -K -O << end >> $psfilep10
-5.8 +0.3
end
psxy -R -JM -St0.6 -G$clr2Y -W$thickL/$blck -K -O << end >> $psfilep10
-5.8  0.0
end
psxy -R -JM -St0.6 -G$clr4P -W$thickL/$blck -K -O << end >> $psfilep10
-5.8 -0.3
end
psxy -R -JM -St0.6 -G$clr7B -W$thickL/$blck -K -O << end >> $psfilep10
-2.8 +0.3
end
psxy -R -JM -St0.6 -G$clr9H -W$thickL/$blck -K -O << end >> $psfilep10
-2.8  0.0
end
psxy -R -JM -St0.6 -G$clrY5 -W$thickL/$blck -K -O << end >> $psfilep10
-2.8 -0.3
end
psxy -R -JM -St0.6 -G$clrY8 -W$thickL/$blck -K -O << end >> $psfilep10
+0.2 +0.3
end
psxy -R -JM -St0.6 -G$clrZ6 -W$thickL/$blck -K -O << end >> $psfilep10
+0.2  0.0
end
...
-5.55  +0.40 10 0 0 TL 1Y (NOA)
-5.55  +0.10 10 0 0 TL 2Y (INGV)
-5.55  -0.20 10 0 0 TL 4P (INGV)
-2.55  +0.40 10 0 0 TL 7B (ODC)
-2.55 +0.10 10 0 0 TL 9H (UIB-NORSAR)
-2.55 -0.20 10 0 0 TL Y5 (ETHZ)
...
psxy -R -JM -Ss0.6 -G$membclr -W$thickL/$blck -K -O << end >> $psfilep11
17.95 1.0
end
psxy -R -JM -Ss0.6 -G$pendclr -W$thickL/$blck -K -O << end >> $psfilep11
17.95 0.5
end
psxy -R -JM -Ss0.6 -G$candclr -W$thickL/$blck -K -O << end >> $psfilep11
17.95 0.0
end
psxy -R -JM -Ss0.6 -G$eidaclr -W$thickL/$blck -K -O << end >> $psfilep11
17.95 -0.5
end
psxy -R -JM -Ss0.5 -W2.0p/$eidaclr -K -O << end >> $psfilep11
17.95 -1.0
end
psxy -R -JM -Ss0.6 -W$thickL/$blck -K -O << end >> $psfilep11
17.95 -1.0
end
# text of the legend
