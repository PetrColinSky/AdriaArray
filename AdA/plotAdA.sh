...
bb240='135/000/135'       # BB > 60s - purple
...
grey='150/150/150'        # permanent stations for map 13 and not yet deployed temporary for map 17 and 18
...
outsA='150/150/250'       # outer BB stations for AA+AdA+PCS
...
# AlpArray, Ivrea and PACASE temporary stations
...
pscoast -R17.6/21.8/40.70/43.8 -Dc -JM20/60/4.89c -G150/150/150 -S150/150/150 -Y+5.2 -X+23.1 -K -O >> $psfile15
...
18.3 43.60 8 0 0 TL AdriaArray members
18.3 43.10 8 0 0 TL membership pending
18.3 42.60 8 0 0 TL candidates
18.3 42.10 8 0 0 TL EIDA nodes for temp. stations
18.3 41.60 8 0 0 TL EIDA nodes for perm. stations
18.3 41.20 8 0 0 TL locations of all branches of the
18.3 40.92 8 0 0 TL member institutions are shown
end
...
# legend to map 17
pscoast -R17.6/21.8/40.70/43.90 -Dc -JM20/60/4.89c -G150/150/150 -S150/150/150 -Y+5.2 -X+23.1 -K -O >> $psfile17
...
18.3 43.60 8 0 0 TL 240s =< period

18.3 43.10 8 0 0 TL 120s =< period < 240s

18.3 42.60 8 0 0 TL  60s =< period < 120s

18.3 42.18 8 0 0 TL  40s =< period <  60s
18.3 42.00 8 0 0 TL (in fact Trillium 40s only)

18.3 41.68 8 0 0 TL  30s =  period
18.3 41.50 8 0 0 TL  (mostly Guralps)

18.3 41.10 8 0 0 TL not deployed yet
end
# end of legend to map 17
...
# legend to map 18
pscoast -R17.6/21.8/40.70/42.40 -Dc -JM20/60/4.89c -G150/150/150 -S150/150/150 -Y+5.2 -X+23.1 -K -O >> $psfile18
...
18.3 42.10 8 0 0 TL BB stations in EIDA
18.3 41.60 8 0 0 TL BB stations not in EIDA
18.8 41.40 8 0 0 TL with station names
18.3 41.10 8 0 0 TL not deployed yet
end
# end of legend to map 18
...
circsize='0.4'
triasize='0.5'
pscoast -R17.6/22.9/40.8/57.25 -Dc -JM20/60/4.0c -G150/150/150 -S150/150/150 -Y+0.2 -X+24.0 -K -O >> $psfile07
...
18.3 57.10 7.5 0 0 TL Serbian Pool
18.3 56.60 7.5 0 0 TL Geoazur + GIPP
18.3 56.10 7.5 0 0 TL Uni Jena, Germany
18.3 55.60 7.5 0 0 TL GIPP, GFZ, Germany
18.3 55.10 7.5 0 0 TL Karlsruhe IT, Germany
18.3 54.60 7.5 0 0 TL NIEP Pool, Romania
18.3 54.10 7.5 0 0 TL Kosovo Pool
18.3 53.60 7.5 0 0 TL Montenegro Pool
18.3 53.10 7.5 0 0 TL Croatia Seism. Survey
18.3 52.60 7.5 0 0 TL INGV Bologna, Italy
18.3 52.10 7.5 0 0 TL ETH Zurich, Switzerland
18.3 51.60 7.5 0 0 TL OGS, Italy
18.3 51.10 7.5 0 0 TL Resif-Sismob, France
18.3 50.60 7.5 0 0 TL Barcelona, Spain
18.3 50.10 7.5 0 0 TL Uni Wien, Austria
18.3 49.60 7.5 0 0 TL Uni Munich, Germany
18.3 49.10 7.5 0 0 TL Uni Bochum, Germany
18.3 48.60 7.5 0 0 TL Uni Twente, the Netherlands
18.3 48.10 7.5 0 0 TL EPSS, Hungary
18.3 47.60 7.5 0 0 TL Uni Kiel, Germany
18.3 47.10 7.5 0 0 TL Norwegian Pool + UniZagreb
18.3 46.60 7.5 0 0 TL Uni Oulu, Finland
18.3 46.10 7.5 0 0 TL Unis + PAS, Poland
18.3 45.60 7.5 0 0 TL Uni Aarhus, Denmark
18.3 45.10 7.5 0 0 TL Uni Helsinki, Finland
...
# legend to map 12
pscoast -R17.6/22.9/40.8/55.30 -Dc -JM20/60/4.0c -G150/150/150 -S150/150/150 -Y+0.2 -X+24.0 -K -O >> $psfile12
# mobile stations - circles
...
18.3 55.10 7.5 0 0 TL Serbian Pool
18.3 54.60 7.5 0 0 TL Geoazur + GIPP
18.3 54.10 7.5 0 0 TL Uni Jena, Germany
18.3 53.60 7.5 0 0 TL GIPP, GFZ, Germany
18.3 53.10 7.5 0 0 TL Karlsruhe IT, Germany
18.3 52.60 7.5 0 0 TL NIEP Pool, Romania
18.3 52.10 7.5 0 0 TL Kosovo Pool
18.3 51.60 7.5 0 0 TL Montenegro Pool
18.3 51.10 7.5 0 0 TL Croatia Seism. Survey
18.3 50.60 7.5 0 0 TL INGV Bologna, Italy
18.3 50.10 7.5 0 0 TL ETH Zurich, Switzerland
18.3 49.60 7.5 0 0 TL OGS, Italy
18.3 49.10 7.5 0 0 TL Resif-Sismob, France
18.3 48.60 7.5 0 0 TL Barcelona, Spain
18.3 48.10 7.5 0 0 TL Uni Wien, Austria
18.3 47.60 7.5 0 0 TL Uni Munich, Germany
18.3 47.10 7.5 0 0 TL Uni Bochum, Germany
18.3 46.60 7.5 0 0 TL Uni Twente, the Netherlands
18.3 46.10 7.5 0 0 TL EPSS, Hungary
18.3 45.60 7.5 0 0 TL Uni Kiel, Germany
18.3 45.10 7.5 0 0 TL Norwegian Pool + UniZagreb
18.3 44.60 7.5 0 0 TL Uni Oulu, Finland
18.3 44.10 7.5 0 0 TL Unis + PAS, Poland
18.3 43.60 7.5 0 0 TL Uni Aarhus, Denmark
18.3 43.10 7.5 0 0 TL Uni Helsinki, Finland
18.3 42.60 7.5 0 0 TL IG CAS Prague, CZ
18.3 42.10 7.5 0 0 TL permanent BB stations
18.3 41.60 7.5 0 0 TL planned permanent stations
18.3 41.10 7.5 0 0 TL mobile BB stations
end
# end of legend to map 12

# legend to map 13      - odect 49
pscoast -R17.6/22.9/-8.2/8.4 -Dc -JM20/60/6.0c -G150/150/150 -S150/150/150 -Y-0.1 -X+24.0 -K -O >> $psfile13
# mobile stations - triangles / circle
#psxy -R -JM -Sc$circsize            -W$thickL/$noneclr -K -O << end >> $psfile13 # not assigned - circle
#17.95  8.50
#end
...
#18.3  8.60 7.5 0 0 TL not assigned
...
18.3 -7.95 7.5 0 0 TL empty triangles: planned
end
...
# legend to map 16
pscoast -R17.6/21.8/40.70/46.40 -Dc -JM20/60/4.89c -G150/150/150 -S150/150/150 -Y+5.2 -X+23.1 -K -O >> $psfile16
...
18.3 46.10 8 0 0 TL 1Y (NOA)
18.3 45.60 8 0 0 TL 2Y (INGV)
18.3 45.10 8 0 0 TL 4P (INGV)
18.3 44.60 8 0 0 TL 7B (ODC)
18.3 44.10 8 0 0 TL 9H (UIB-NORSAR)
18.3 43.60 8 0 0 TL Y5 (ETHZ)
18.3 43.10 8 0 0 TL Y8 (NIEP)
18.3 42.60 8 0 0 TL Z6 (LMU)
18.3 42.10 8 0 0 TL XP (RESIF)
18.3 41.60 8 0 0 TL ?? (GFZ)
...
pscoast -R17.6/22.5/47.50/47.70 -Dc -JM20/60/6.2c -G255/255/255 -S255/255/255 -Y-0.5 -X-2.2 -K -O >> $psfile13
pstext -R -JM -G0/0/0 -K -O << end >> $psfile13
20.0 47.70 10 0 0 TL $datum
end
pscoast -R17.6/22.5/47.50/47.70 -Dc -JM20/60/6.2c -G255/255/255 -S255/255/255 -Y-10.6 -X-1.3 -K -O >> $psfile14
pstext -R -JM -G0/0/0 -K -O << end >> $psfile14
20.0 47.70 10 0 0 TL $datum
end
