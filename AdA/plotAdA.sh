...
grey='150/150/150'        # permanent stations for map 13 and not yet deployed temporary for map 17
...
pscoast -R17.6/22.5/47.50/47.90 -Dc -JM20/60/6.2c -G255/255/255 -S255/255/255 -Y-5.8 -X-1.3 -K -O >> $psfile17
pstext -R -JM -G0/0/0 -K -O << end >> $psfile17
20.0 47.70 10 0 0 TL $datum
end
# end of date stamp
...
gswin32c.exe -o MAPS/17AdAcorners.pdf -sDEVICE=pdfwrite -r3600 -g29772x42084 -dPDFFitPage $psfile17
...
gswin32c.exe -o MAPS/17AdAcorners.png -sDEVICE=png16m -r500 -c '<</Orientation 3>> setpagedevice' -dDownScaleFactor=4 $psfile17